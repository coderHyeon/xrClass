...
{
    [SerializeField] GameObject bulletPrefab;// 생성할 탄알의 원본 프리팹
    [SerializeField] float spawnRateMin = 0.5f; //최소 생성주기
    [SerializeField] float spawnRateMax = 3f; //최대생성 주기
    ...
    {//최근 생성 이후의 누적 시간을 0으로 초기화
        timeAfterSpawn = 0f;
        //탄알 생성 간격을 spawnRateMin 과 spawnRateMax 사이에서 지정
    ...
    void Update()
    {
        ...
        if(timeAfterSpawn >= spawnRate)
        {
            ...
            //생성된  bullet 게임 오브젝트의 정면 방향이 targetㅇ르 향하도록 회전
